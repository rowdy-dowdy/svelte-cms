...
<div id="admin">
  <div class="w-full h-screen flex bg-primary-100">
    <div class="flex-none h-full">
      <div class="h-full flex bg-white">
        <div class="p-4 border-r flex flex-col space-y-6">
          ...
          <a href="/admin" class="icon w-10 h-10 rounded-xl p-1.5 hover:bg-primary-200 border-2 border-transparent
            {$page.url.pathname == "/admin" ? '!border-primary-800' : ''}"
          >
          ...
          <a href="/admin/logs" class="icon w-10 h-10 rounded-xl p-1.5 hover:bg-primary-200 border-2 border-transparent
            {$page.url.pathname == "/admin/logs" ? '!border-primary-800' : ''}"
          >
          ...
          <a href="/admin/settings" class="icon w-10 h-10 rounded-xl p-1.5 hover:bg-primary-200 border-2 border-transparent
            {$page.url.pathname == "/admin/settings" ? '!border-primary-800' : ''}"
          >
          ...
          <div class="!mt-auto">
            <div id="userImage" class="w-10 h-10 rounded-full overflow-hidden bg-primary-200 select-none cursor-pointer">
              <img src="{data.user.image}" alt="logo" class="w-full h-full object-contain">
            </div>
            <Dropdown placement="top-start" triggeredBy="#userImage">
              ...
              <DropdownItem slot="footer" class="text-red-600 hover:bg-red-100"
                on:click={logout}
